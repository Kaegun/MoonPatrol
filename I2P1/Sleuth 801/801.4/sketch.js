...
Officer: 1192743
CaseNum: 801-3-47694485-1192743

One last chance to record the Cooley gang before the curtain comes down on the Marriage of Figaro. 
They might be the most influential group in console city but they still have their quirks and will be spotable thanks their trademark top hat.
...
You’ll want to set the caught property of the operaBuffs array to true when the equivalent element of the gangMember is also true.
...
var gangMember = [false, false, false, true, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, true, false, false, false, false, true, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false];
...
function draw() {
	...
	for (var i = 0; i < operaBuffs.length; i++) {
		for (var j = 0; j < operaBuffs[i].length; j++) {
			operaBuffs[i][j].caught = gangMember[i * operaBuffs.length + j];
		}
	}
