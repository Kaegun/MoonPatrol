...
Officer: 1192743
CaseNum: 801-1-25003157-1192743
...
This vein lot should be easy to spot thanks to their distinguished retro glasses. They must be up to something kid...

They are all sitting in the 4th seat of each row.

We better act fast and tighten up our operation. 
This is a slicker operation than before, you’ll have to use a single for loop to pick them out and set selected property of the theatregoers to true
...
function draw() {
	...
	for (var i = 0; i < theatregoers.length; i++) {
		theatregoers[i][3].selected = true;
	}
