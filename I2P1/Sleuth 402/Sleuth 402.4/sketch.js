...
Officer: 1192743
CaseNum: 402-3-12138228-1192743
...
function draw() {
	...
	if (det.locationY > 135 && det.locationX < 200) {
		turnEast();
	}
	if (det.locationX > 700 && det.locationY < 260) {
		turnSouth();
	}
	if (det.locationX > 700 && det.locationY > 260 && det.locationY < 445) {
		turnWest();
	}
	if (det.locationX < 260 && det.locationY > 260) {
		turnSouth();
	}
	if (det.locationX < 260 && det.locationY > 445 && det.locationY < 570) {
		turnEast();
	}
	if (det.locationX > 825 && det.locationY < 570) {
		turnSouth();
	}
	if (det.locationX > 450 && det.locationY > 570 && det.locationY < 630) {
		turnWest();
	}
	if (det.locationX < 450 && det.locationY > 570 && det.locationY < 630) {
		turnSouth();
	}
	if (det.locationX < 450 && det.locationY > 630) {
		turnEast();
	}
	if (det.locationX > 760 && det.locationY > 630) {
		turnSouth();
	}
