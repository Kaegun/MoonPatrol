...
The Game Project -- Mid-term submission
...
function createCollectables() {
	var numCollectables = random(2, 8);
	console.log(`Creating ${numCollectables} collectables`);
	for (var i = 0; i < numCollectables; i++) {

		console.log(`Creating ${i} of ${numCollectables} collectables`);
		...
		console.log(`collectable valid? ${valid}`);
...
function drawEndOfLevel() {
	textSize(50);
	fill(0, 255, 0);
	text('THE END', gameWorld_x - textWidth('THE END') - 100, floorPos_y - 100);
}